    ...
    def notification_to_the_channel(self, channel_id: str, link: str) -> None:
        ...
        try:
            ...
            WebClient(token=slack_token).chat_postMessage(
                ...
                "*✓✓ – Success!*\n>" +
                "*Not Found – Employee is not found!*\n\n" +
                ":googledrive: See the archive <https://drive.google.com/drive/folders/1Lfa-v8YTISfOomL_4CxHgR4q0zfenTXk|_*here*_>!\n" +
                ":exclamation: See <https://jaxel-inc.atlassian.net/wiki/spaces/ITA/pages/11124015146/Employee+Profile+Identification|_*instruction*_> for more information.\n" +
                "Have a great week!"
            )
